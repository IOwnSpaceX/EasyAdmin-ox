...
module.exports = {
	...
	async execute(interaction, exports) {
		if (!await DoesGuildMemberHavePermission(interaction.member, 'player.mute')) {
			return interaction.reply({ content: 'Insufficient permissions: `easyadmin.player.mute`', ephemeral: true })
		}
