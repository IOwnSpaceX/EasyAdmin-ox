...
module.exports = {
	...
	async execute(interaction, exports) {
		if (!await DoesGuildMemberHavePermission(interaction.member, 'player.unjail')) {
			return interaction.reply({ content: 'Insufficient permissions: `easyadmin.player.unjail`', ephemeral: true })
		}
