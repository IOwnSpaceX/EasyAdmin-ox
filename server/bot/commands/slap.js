...
module.exports = {
	...
	async execute(interaction, exports) {
		if (!await DoesGuildMemberHavePermission(interaction.member, 'player.slap')) {
			return interaction.reply({ content: 'Insufficient permissions: `easyadmin.player.slap`', ephemeral: true })
		}
