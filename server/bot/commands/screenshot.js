...
module.exports = {
	...
	async execute(interaction, exports) {
		if (!await DoesGuildMemberHavePermission(interaction.member, 'player.screenshot')) {
			return interaction.reply({ content: 'Insufficient permissions: `easyadmin.player.screenshot`', ephemeral: true })
		}
