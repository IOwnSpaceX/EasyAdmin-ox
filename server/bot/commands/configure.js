...
module.exports = {
	...
	async execute(interaction, exports) {
		if (!await DoesGuildMemberHavePermission(interaction.member, 'server.convars')) {
			return interaction.reply({ content: 'Insufficient permissions: `easyadmin.server.convars`', ephemeral: true })
		}
