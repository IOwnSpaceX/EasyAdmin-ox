...
module.exports = {
	...
	async execute(interaction, exports) {
		if (!await DoesGuildMemberHavePermission(interaction.member, 'player.ban.remove')) {
			return interaction.reply({ content: 'Insufficient permissions: `easyadmin.player.ban.remove`', ephemeral: true })
		}
