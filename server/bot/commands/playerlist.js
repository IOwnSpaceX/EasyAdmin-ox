...
module.exports = {
	...
	async execute(interaction, exports) {
		if (!await DoesGuildMemberHavePermission(interaction.member, 'bot.playerlist')) {
			return interaction.reply({ content: 'Insufficient permissions: `easyadmin.bot.playerlist`', ephemeral: true })
		}
