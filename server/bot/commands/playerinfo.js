...
module.exports = {
	...
	async execute(interaction, exports) {
		if (!await DoesGuildMemberHavePermission(interaction.member, 'player.info')) {
			return interaction.reply({ content: 'Insufficient permissions: `easyadmin.player.info`', ephemeral: true })
		}
		...
		var table = displayedIdentifiers.join('\n')
