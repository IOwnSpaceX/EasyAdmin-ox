...
module.exports = {
	...
	async execute(interaction, exports) {
		if (!await DoesGuildMemberHavePermission(interaction.member, 'player.freeze')) {
			return interaction.reply({ content: 'Insufficient permissions: `easyadmin.player.freeze`', ephemeral: true })
		}
